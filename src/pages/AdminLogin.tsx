        ...
        <section className="grid w-full overflow-hidden rounded-2xl bg-flexWhite/95 shadow-2xl ring-1 ring-flexBlack/15 md:grid-cols-2">
          <div className="relative hidden overflow-hidden bg-flexBlack p-10 text-flexWhite md:flex md:flex-col md:justify-between">
            ...
            <p className="max-w-xs text-sm leading-relaxed text-flexWhite/85">
              Sign in as administrator to manage operations and monitor members.
            </p>
          </div>

          <div className="p-6 sm:p-8 md:p-10">
            <h2 className="text-2xl font-semibold text-flexBlack sm:text-3xl">Admin Login</h2>
            ...
            <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full rounded-lg bg-flexBlue px-4 py-2.5 text-sm font-semibold text-flexWhite transition hover:bg-flexNavy"
              >
                {loading ? "Signing in..." : "Login as Admin"}
              </button>
            </form>

            <div className="mt-5 flex items-center justify-between gap-2 text-sm text-flexNavy">
